...
echo -e "${whiteK}\E[44;1;39m                   👑 ALVI CELL TUNNEL 👑                          \E[0m"
echo -e "${Red}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "     ${BICyan}[${BIWhite}1${BICyan}]👉 SSH    " "  ${BICyan}[${BIWhite}6${BICyan}]👉 TRIALL    "
echo -e "     ${BICyan}[${BIWhite}2${BICyan}]👉 VMESS  " "  ${BICyan}[${BIWhite}7${BICyan}]👉 BACKUP    "
echo -e "     ${BICyan}[${BIWhite}3${BICyan}]👉 VLESS  " "  ${BICyan}[${BIWhite}8${BICyan}]👉 ADD-HOST  "
echo -e "     ${BICyan}[${BIWhite}4${BICyan}]👉 TROJAN " "  ${BICyan}[${BIWhite}9${BICyan}]👉 RUNNING   "
echo -e "     ${BICyan}[${BIWhite}5${BICyan}]👉 SETING " "  ${BICyan}[${BIWhite}10${BICyan}]👉 SET REBOOT"
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"
